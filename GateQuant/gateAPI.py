...
class GateIO:
    ...
    # K线数据
    def candle(self, currencyPair, group_sec, range_hour):
        URL = "/api2/1/candlestick2/" + currencyPair.lower() + '?group_sec=' + str(group_sec) + '&range_hour=' + str(range_hour)
        params = {}
        return httpPost(self.__url, URL, params, self.__apiKey, self.__secretKey)